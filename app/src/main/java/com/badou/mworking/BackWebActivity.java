...
public class BackWebActivity extends BaseBackWebViewActivity {
	...
	public static final String VALUE_TAG = "NOTICE_tag";
	...
	private void showPingfenDilog(){
		...
		if(BackWebActivity.PAGEFLAG == BackWebActivity.TRAINING){
			...
			if(train!=null){
				...
				new CoursewareScoreDilog(BackWebActivity.this,train.getRid(),coursewareScore,new CoursewareScoreDilogListener() {
