...
public class Exam extends Category {
    ...
    public static boolean getUnreadNum(Context context) {
        String account = ((AppApplication) context.getApplicationContext()).getUserInfo().account;
        String sp = SP.getStringSP(context, SP.DEFAULTCACHE, account + Exam.CATEGORY_KEY_UNREAD_NUM, "");
