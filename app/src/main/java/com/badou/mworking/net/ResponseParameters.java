...
public class ResponseParameters {
    ...
    public static final String QUESTION_EMPLOYEE_ID = "employee_id";//用户名
    public static final String QUESTION_WHOM = "whom";//员工号
    ...
    public static final String QUESTION_PHOTO_URL = "photos";//图片地址
    public static final String QUESTION_PICTURE_URL = "picurl";//图片地址
    public static final String QUESTION_VIDEO_URL = "videourl";//视频地址
