 ...
 * 问答回答页面
 */
public class WenDaAnswerActivity extends BaseBackActionBarActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wendaansweractivity);
		init();
	}
	...
	private void init(){
		...
		ivQuestionImg = (ImageView) findViewById(R.id.iv_huida_image);
		ivQuestionImgdel = (ImageView) findViewById(R.id.iv_huida_image_delete);
	...
	public void clickRight() {
  	...
  	private void sendWenDaContent() {
  		...
  		// 提交提问内容
  		ServiceProvider.doPublishAnswer(mContext,content, aid, photo,
	...
	private void OpenAlbum(Intent data){
		...
		String path = getPath(WenDaAnswerActivity.this,originalUri);
