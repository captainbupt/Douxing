...
public class AppApplication extends Application {
	...
	public void setUserInfo(UserInfo userInfo) {
		...
		tags.add(userInfo.getTag());
		if (JPushInterface.isPushStopped(this))
			JPushInterface.resumePush(this);
		JPushInterface.setTags(getApplicationContext(), tags, null);
		JPushInterface.setAlias(getApplicationContext(), userInfo.getUserId(),
				null);
		MTrainingDBHelper.getMTrainingDBHelper().createUserTable(userInfo.getUserNumber());
	}
