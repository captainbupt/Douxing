...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private void postReport(File file) {
        ...
        try {
            ServiceProvider.doSubmitError(mContext, str, getVersionName(), null);
        } catch (Exception e) {
            e.printStackTrace();
            ServiceProvider.doSubmitError(mContext, str, "versionFail", null);
        }
    }
    ...
    private String getVersionName() throws Exception {
        ...
        PackageInfo packInfo = packageManager.getPackageInfo(mContext
