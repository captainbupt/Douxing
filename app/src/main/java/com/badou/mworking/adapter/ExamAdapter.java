...
/**
 * 类:  <code> ExamAdapter </code>
 * 功能描述:  在线考试列表页适配器
 * 创建人:  葛建锋
 * 创建日期: 2014年12月17日 上午10:53:00
 * 开发环境: JDK7.0
 */
public class ExamAdapter extends BaseAdapter {
	...
	public static boolean isHistoryTest = false;         //判断判断是不是历史考试模块

	public ExamAdapter(Context mContext, ArrayList<Exam> mData,String done) {
		this.mInflater = LayoutInflater.from(mContext);
		this.mData = mData == null ? new ArrayList<Exam>() : mData;
	 ...
	 * @param mData
	 */
	public void setDatas(ArrayList<Exam> mData) {
		this.mData = mData == null ? new ArrayList<Exam>() : mData;
		notifyDataSetChanged();
	}
	 ...
	 * @param mData
	 */
	public void addData(ArrayList<Exam> mData){
		if (null != mData) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (exam.getTop() == Constant.TOP_YES&&TextUtils.isEmpty(done)) {
