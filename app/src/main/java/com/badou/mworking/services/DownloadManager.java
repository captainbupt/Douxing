...
import com.badou.mworking.util.ConfigUtils;
...
/**
 * 类:  <code> DownloadManager </code>
 * 功能描述: 
 * 创建人: 葛建锋
 * 创建日期: 2013-12-2 上午9:11:35
 * 开发环境: JDK6.0
 */
public class DownloadManager extends Thread {

    private static final int MAX_TASK_COUNT = 100;     //
    private static final int MAX_DOWNLOAD_THREAD_COUNT = 3;      //最大开启线程数3条
    ...
    private void broadcastAddTask(String url, boolean isInterrupt) {
        ...
        Intent nofityIntent = new Intent("com.badou.mworking.TrainVideoPlayerAct");
    ...
    private DownloadTask newDownloadTask(String url) throws MalformedURLException {
        ...
        DownloadTaskListener taskListener = new DownloadTaskListener() {
            ...
            public void updateProcess(DownloadTask task) {
                ...
                Intent updateIntent = new Intent("com.badou.mworking.TrainVideoPlayerAct");
        ...
        String filePath = FileUtils.getTrainCacheDir(mContext);
        return new DownloadTask(mContext, url, filePath, taskListener);
    }

    /**
     * 类:  <code> TaskQueue </code>
     * 功能描述:  A obstructed task queue  一个阻塞任务队列
     * 创建人: 葛建锋
     * 创建日期: 2013-12-2 上午9:16:58
     * 开发环境: JDK6.0
     */
