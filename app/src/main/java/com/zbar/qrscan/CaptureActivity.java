 ...
 * 描述: 扫描界面
 */
public class CaptureActivity extends BaseNoTitleActivity implements Callback {
    ...
    public void handleDecode(String result) {
        ...
        setResult(RESULT_OK, TaskSignPresenter.createResult(result));
        finish();
    }
