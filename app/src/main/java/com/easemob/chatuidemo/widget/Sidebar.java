...
public class Sidebar extends View {
    ...
    public void setListView(StickyListHeadersListView mStickyListView) {
        this.mStickyListView = mStickyListView;
    }
    ...
    private void setHeaderTextAndscroll(MotionEvent event) {
        if (mListView == null && mStickyListView == null) {
            ...
            for (int i = adapterSections.length - 1; i > -1; i--) {
                if (adapterSections[i].equals(headerString)) {
                    if (mListView != null) {
                        ...
                        mStickyListView.setSelection(adapter.getPositionForSection(i));
                    }
                    break;
                }
            }
